...
public class SwaggerConfig {
	...
	private ApiInfo metaDeta() {
		ApiInfo apiInfo = new ApiInfo("Ecommerce Sporty Shoes REST API ",
				"Ecommerce Products REST API for online store Sporty Shoes", "1.0.0", "Term of service as per user guide lines.", 
