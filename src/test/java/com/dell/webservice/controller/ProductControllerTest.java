...
public class ProductControllerTest {
	...
	public void testGetUserById() {
		...
		String url = "http://localhost:"+randomPort+"/api/v1/product/getproduct/15";
	...
	public void testAddUser() {
		...
		String url = "http://localhost:"+randomPort+"/api/v1/product/adduser";
	...
	public void testUpdateProduct() {
		...
		String url = "http://localhost:"+randomPort+"/api/v1/product/updateproduct/15";
	...
	public void testDeleteProduct() {
		...
		String url = "http://localhost:"+randomPort+"/api/v1/product/deleteproduct/15";
